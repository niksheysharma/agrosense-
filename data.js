...
const translations = {
    EN: {
        ...
        farmStatus: "Unified monitoring active: Early disease detection & soil intelligence.",
        alertTitle: "Yield Protection Alert",
        alertDesc: "High risk of Aphids matching regional trends. Early intervention saves up to 30% yield.",
        soilHealth: "Real-time Soil Health",
        seeAll: "Details",
        recentScans: "Recent Scans",
        newScan: "New Diagnosis",
        quickScanText: "Upload Image to Detect Disease",
    ...
    HI: {
        ...
        farmStatus: "एकीकृत निगरानी सक्रिय: प्रारंभिक रोग का पता लगाना और मिट्टी की खुफिया जानकारी।",
        alertTitle: "उपज संरक्षण अलर्ट",
        alertDesc: "क्षेत्रीय रुझानों के अनुसार एफिड्स का उच्च जोखिम। प्रारंभिक हस्तक्षेप 30% तक उपज बचाता है।",
        soilHealth: "रीयल-टाइम मिट्टी का स्वास्थ्य",
        seeAll: "विवरण",
        recentScans: "हाल के स्कैन",
        newScan: "नया निदान",
        quickScanText: "रोग का पता लगाने के लिए छवि अपलोड करें",
